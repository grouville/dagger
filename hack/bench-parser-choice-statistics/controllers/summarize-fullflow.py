...
ROOT = Path('/tmp/dagger-parser-stats.I2WPGLrS')
...
def main():
    ...
    result = dict(scope='Three independent AB/BA/AB matched engine pairs, same CLI and generated parser grammar; per-run warm repeats summarized first.',
        limits=['First check and external upgrade profiled; other timed scenarios unprofiled',
