...
base=Path('/tmp/collections-perf/tar-parent-cache/warm');base.mkdir(exist_ok=True)
...
variants={'control':('dagger-engine.collections-tar-parent-full-control-0',6134),'candidate':('dagger-engine.collections-tar-parent-full-candidate-0',6135)}
rows=[]
