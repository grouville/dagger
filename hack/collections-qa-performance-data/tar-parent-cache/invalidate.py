...
base=Path('/tmp/collections-perf/tar-parent-cache/invalidation')
base.mkdir(exist_ok=True)
runner='/home/dagger/dag/hack/bench-artifact-discovery.py'
variants={
 'original':('/tmp/collections-perf/committed/dagger','container://dagger-engine.collections-tar-parent-full-control-0',Path('/tmp/collections-perf/normal-baseline/greetings-split')),
 'candidate':('/tmp/collections-perf/committed/dagger','container://dagger-engine.collections-tar-parent-full-candidate-0',Path('/tmp/collections-perf/tar-parent-cache/workspace')),
}
if not variants['candidate'][2].exists():
 shutil.copytree(variants['original'][2], variants['candidate'][2])
