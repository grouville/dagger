...
B=Path('/tmp/collections-perf/shutdown-overlap');dest=B/'pairs';dest.mkdir(exist_ok=False)
...
variants={
 ...
 'overlap-512':('/tmp/collections-perf/shutdown-overlap/dagger','dagger-engine.collections-disk-abba-1',6171),
}
