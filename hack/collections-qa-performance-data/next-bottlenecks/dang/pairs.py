...
B=Path('/tmp/collections-perf/sdk-edit-audit');dest=B/'pairs';dest.mkdir(exist_ok=False)
...
variants={
 ...
 'dang-prepare':('/tmp/collections-perf/rebase-main/dagger','dagger-engine.collections-disk-abba-1',6171),
}
