...
base=Path('/tmp/collections-perf/ts-cache/node-results');base.mkdir(exist_ok=True)
...
variants={'control':('dagger-engine.collections-kyle-syntax',6097),'node-cache':('dagger-engine.collections-node-cache',6098)}
rows=[]
...
run('setup/node-cache','node-cache')
