...
base=Path('/tmp/collections-perf/next-final/invalidation')
runner='/home/dagger/dag/hack/bench-artifact-discovery.py'
variants={
 'original':('/tmp/collections-perf/untouched-pr/dagger','container://dagger-engine.collections-kyle-original',Path('/tmp/collections-perf/kyle-latest/greetings-api')),
 'candidate':('/tmp/collections-perf/committed/dagger','container://dagger-engine.collections-kyle-syntax',Path('/tmp/collections-perf/next-final/workspace')),
}
def keys(data):
    out=[]
