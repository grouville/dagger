...
base=Path('/tmp/collections-perf/ts-cache/split-imports/cold');base.mkdir(exist_ok=True)
...
variants={
 'control':{'engine':'dagger-engine.collections-split-cold-control','port':6099,'binary':'/tmp/collections-perf/syntax-isolated/engine','cli':cli,'fresh':True,'workspace':'/tmp/collections-perf/kyle-latest/greetings-api'},
 'split':{'engine':'dagger-engine.collections-split-cold-candidate','port':6100,'binary':'/tmp/collections-perf/syntax-isolated/engine','cli':cli,'fresh':True,'workspace':'/tmp/collections-perf/ts-cache/split-imports/workspace'},
}
