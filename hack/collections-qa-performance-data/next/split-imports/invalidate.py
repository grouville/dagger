...
base=Path('/tmp/collections-perf/ts-cache/split-imports/invalidation')
runner='/home/dagger/dag/hack/bench-artifact-discovery.py'
variants={
 'original':('/tmp/collections-perf/committed/dagger','container://dagger-engine.collections-kyle-syntax',Path('/tmp/collections-perf/kyle-latest/greetings-api')),
 'candidate':('/tmp/collections-perf/committed/dagger','container://dagger-engine.collections-kyle-syntax',Path('/tmp/collections-perf/ts-cache/split-imports/workspace')),
}
def keys(data):
    out=[]
