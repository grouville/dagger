...
base=Path('/tmp/collections-perf/schema-decode/warm-repeat');base.mkdir(exist_ok=True)
...
variants={'control':('dagger-engine.collections-public-refs',6142),'candidate':('dagger-engine.collections-schema-decode',6143)}
rows=[]
