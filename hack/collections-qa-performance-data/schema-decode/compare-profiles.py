...
base=Path('/tmp/collections-perf/schema-decode')
for label,engine,port in [('control','dagger-engine.collections-public-refs',6142),('candidate','dagger-engine.collections-schema-decode',6143)]:
