...
base=Path('/tmp/collections-perf/half-second/invalidation')
...
variants={
 ...
 'candidate':('/tmp/collections-perf/committed/dagger','container://dagger-engine.collections-tsx-cache',Path('/tmp/collections-perf/half-second/workspace')),
}
