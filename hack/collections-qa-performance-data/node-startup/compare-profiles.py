...
base=Path('/tmp/collections-perf/half-second')
for label,engine,port in [('control','dagger-engine.collections-schema-decode',6143),('candidate','dagger-engine.collections-tsx-cache',6144)]:
