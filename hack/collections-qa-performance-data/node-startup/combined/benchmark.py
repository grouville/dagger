...
b=Path('/tmp/collections-perf/half-second/combined');ws=Path('/tmp/collections-perf/normal-baseline/greetings-split')
variants={'control':'dagger-engine.collections-schema-decode','candidate':'dagger-engine.collections-tsx-node-cache'}
