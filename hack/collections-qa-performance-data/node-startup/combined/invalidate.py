...
base=Path('/tmp/collections-perf/half-second/combined/invalidation')
base.mkdir(exist_ok=True)
runner='/home/dagger/dag/hack/bench-artifact-discovery.py'
variants={
 'original':('/tmp/collections-perf/committed/dagger','container://dagger-engine.collections-schema-decode',Path('/tmp/collections-perf/normal-baseline/greetings-split')),
 'candidate':('/tmp/collections-perf/committed/dagger','container://dagger-engine.collections-tsx-node-cache',Path('/tmp/collections-perf/half-second/workspace')),
}
