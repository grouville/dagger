...
b=Path('/tmp/collections-perf/half-second/node-compile');ws=Path('/tmp/collections-perf/normal-baseline/greetings-split')
variants={'control':'dagger-engine.collections-tsx-cache','candidate':'dagger-engine.collections-tsx-node-cache'}
