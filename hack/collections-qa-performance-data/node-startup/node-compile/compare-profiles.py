...
base=Path('/tmp/collections-perf/half-second/node-compile')
for label,engine,port in [('control','dagger-engine.collections-tsx-cache',6144),('candidate','dagger-engine.collections-tsx-node-cache',6145)]:
