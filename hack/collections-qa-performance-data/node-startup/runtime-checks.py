...
base=Path('/tmp/collections-perf/half-second/runtime-checks');base.mkdir(exist_ok=True)
os.environ.pop('SSH_AUTH_SOCK',None)
cli='/tmp/collections-perf/committed/dagger';engine='container://dagger-engine.collections-tsx-cache'
