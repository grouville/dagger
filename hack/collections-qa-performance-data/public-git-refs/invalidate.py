...
base=Path('/tmp/collections-perf/warm-next/invalidation')
base.mkdir(exist_ok=True)
runner='/home/dagger/dag/hack/bench-artifact-discovery.py'
variants={
 'original':('/tmp/collections-perf/committed/dagger','container://dagger-engine.collections-go-import-quiet-1',Path('/tmp/collections-perf/normal-baseline/greetings-split')),
 'candidate':('/tmp/collections-perf/committed/dagger','container://dagger-engine.collections-public-refs',Path('/tmp/collections-perf/warm-next/workspace')),
}
