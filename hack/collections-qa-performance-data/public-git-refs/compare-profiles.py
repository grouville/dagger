...
base=Path('/tmp/collections-perf/warm-next')
for label,engine,port in [('control','dagger-engine.collections-go-import-quiet-1',6128),('candidate','dagger-engine.collections-public-refs',6142)]:
