...
base=Path('/tmp/collections-perf/greetings/batch-qa');base.mkdir(exist_ok=True)
rows=[]
for variant,cli,engine,workspace,port in [
 ('original','/tmp/collections-perf/untouched-pr/dagger','dagger-engine.collections-untouched','/tmp/greetings-api-collections-perf',6080),
 ('full-stack','/tmp/collections-perf/dagger-pinned-discovery','dagger-engine.collections-profile-stack','/tmp/greetings-api-optimized-perf',6066)]:
