...
B=Path('/tmp/collections-perf/post-rebase-io');dest=B/'rebase-pairs';dest.mkdir(exist_ok=False)
...
variants={
 'pre-rebase':('/tmp/collections-perf/cli-boundaries/dagger-early-analytics','dagger-engine.collections-artifact-schema-fork',6146),
 'rebased':('/tmp/collections-perf/rebase-main/dagger','dagger-engine.collections-disk-abba-3',6173),
 'rebased-512':('/tmp/collections-perf/rebase-main/dagger','dagger-engine.collections-disk-abba-2',6172),
}
env=dict(os.environ)
