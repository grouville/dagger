...
rows=[]
for variant,port in [('candidate',6117)]:
    name='dagger-engine.collections-prebuilt-cold-repeat'
    ...
    (base/'repeat/results.json').write_text(json.dumps(rows,indent=2)+'\n');print(json.dumps(row),flush=True)
