...
base=Path('/tmp/collections-perf/prebuilt-ts-sdk/warm');base.mkdir(exist_ok=True)
...
variants={'control':('dagger-engine.collections-ts-runtime-manifest',6110),'full':('dagger-engine.collections-prebuilt-ts-sdk',6114)}
rows=[]
