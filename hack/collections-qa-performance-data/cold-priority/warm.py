...
base=Path('/tmp/collections-perf/ts-runtime-manifest/warm');base.mkdir(exist_ok=True)
...
variants={'control':('dagger-engine.collections-cold-priority',6109),'full':('dagger-engine.collections-ts-runtime-manifest',6110)}
rows=[]
