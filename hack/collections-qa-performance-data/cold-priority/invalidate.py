...
base=Path('/tmp/collections-perf/ts-runtime-manifest/invalidation')
base.mkdir(exist_ok=True)
runner='/home/dagger/dag/hack/bench-artifact-discovery.py'
variants={
 'original':('/tmp/collections-perf/committed/dagger','container://dagger-engine.collections-cold-priority',Path('/tmp/collections-perf/normal-baseline/greetings-split')),
 'candidate':('/tmp/collections-perf/committed/dagger','container://dagger-engine.collections-ts-runtime-manifest',Path('/tmp/collections-perf/ts-runtime-manifest/workspace')),
}
