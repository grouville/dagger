...
rows=[]
for variant,port in [('candidate',6121)]:
    name='dagger-engine.collections-go-import-isolated'
    ...
    (base/'isolated/results.json').write_text(json.dumps(rows,indent=2)+'\n');print(json.dumps(row),flush=True)
