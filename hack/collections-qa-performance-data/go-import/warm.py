...
base=Path('/tmp/collections-perf/go-import/warm');base.mkdir(exist_ok=True)
...
variants={'control':('dagger-engine.collections-go-import-control-0',6122),'full':('dagger-engine.collections-go-import-candidate-0',6123)}
rows=[]
