...
ROOT = Path('/tmp/dagger-preconnect-flow.xir7YN88')
...
def main():
    ...
    result = dict(scope='Three independent AB/BA/AB matched CLI pairs, same engine image; per-run warm repeats summarized first.',
        ...
        cohorts=3, profiles=36, cache_analyses=18, warm_rebuild_audits=36,
