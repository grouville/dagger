...
def main():
    ...
    assert cohort.parent == Path('/tmp') and cohort.name.startswith('dagger-rust-single-source-ab-')
    ...
    for sample in meta['runs']:
        ...
        assert fixture['module_sha256'] == meta['module_sha256'][sample['side']]
        assert fixture['module_dir'] == meta['module_paths'][sample['side']]
