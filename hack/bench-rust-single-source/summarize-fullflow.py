...
ROOT = Path('/tmp/dagger-rust-single-source.FwiNYoEd')
...
def main():
    ...
    result = dict(scope='Three independent AB/BA/AB module pairs on identical parser engine and CLI; per-run warm repeats summarized first.',
        limits=['First check and external upgrade profiled; other timed scenarios omit --profile but still export local OTLP',
        ...
        cohorts=1, independent_pairs=3, profiles=36, cache_analyses=18, warm_rebuild_audits=36,
