...
def main():
    ...
    result = dict(scope='Three independent AB/BA/AB matched CLI pairs, same validated stream engine and official gzip Rust image; readiness CLI comparison; per-run warm repeats summarized first.',
