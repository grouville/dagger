...
CLI_OWNER = Path("/tmp/dagger-cli-readiness-current.AS6z1ng4")
...
HASHES = {
    ...
    CLI_OWNER / 'build-inputs.sha256': '28a1d8f7293394b73ab13776dbbb14bb5bfbe4f0a9f9585f3f9606c1d8c9f6a3',
    CLI_OWNER / 'after.log': '076700faf4dd4208ee2c78b7ab8d28b93b34be1dd43d472cdb50058ebe244586',
    ...
    HERE / 'debug-get': 'd50874b7f7c0235bececcb4dbad34655dcadf06452cc3f767d11a9b6160cc5d8',
    HERE / 'debug-get.go': 'dd4752ab73cd53327655b8a86e430c8615e4745be5af7bc35f6ca63b58114be5',
...
def main():
    ...
    receiver = subprocess.Popen([str(RECEIVER), '-addr', '127.0.0.1:43240', '-out', str(RAW)],
