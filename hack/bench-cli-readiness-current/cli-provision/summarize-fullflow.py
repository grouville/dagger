...
def main():
    ...
    result = dict(scope='Three independent AB/BA/AB matched CLI pairs, same validated stream engine and official gzip Rust image; readiness CLI comparison with ordinary CLI-managed engine provisioning inside first-command timer; per-run warm repeats summarized first.',
