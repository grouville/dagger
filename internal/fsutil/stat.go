...
func mkstat(path, relpath string, fi os.FileInfo, inodemap map[uint64]string, skipXattrs bool) (*types.Stat, error) {
...
func Stat(path string) (*types.Stat, error) {
	...
	return mkstat(path, filepath.Base(path), fi, nil, false)
}
